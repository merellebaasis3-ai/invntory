    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='katol_inventory_management.product')),
            ],
        ),
        migrations.CreateModel(
            name='Stock_Movement',
        ...
        migrations.AddField(
            model_name='product',
            name='supplier',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='katol_inventory_management.supplier'),
        ),
    ]
